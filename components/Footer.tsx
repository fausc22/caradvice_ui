...
export default function Footer() {
  ...
  return (
    <>
      {/* Widget de reseñas Trustindex - Arriba del footer */}
      <div className="font-antenna bg-white py-8 sm:py-12">
      ...
      <footer className="font-antenna bg-black text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {/* 
            ...
            Desktop (≥1024px): 3 columnas - Logo | Descripción | Contacto
            Mobile (<1024px): 1 columna - Layout vertical natural
          */}
          <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr_1fr] gap-8 lg:gap-10 py-8 lg:py-10">
            {/* 
              Columna 1: Logo
              - Define la altura inicial del contenido (ancla del layout)
              - Alineado al inicio verticalmente
              - Tamaño responsive: más grande en mobile, proporcional en desktop
            */}
            <div className="flex items-start justify-center lg:justify-start">
              <Link href="/" className="group">
                <div className="w-[280px] sm:w-[320px] md:w-[340px] lg:w-[280px] xl:w-[320px]">
                  <Image
                    src="/logo-footer.png"
                    alt="CarAdvice"
                    width={400}
                    height={133}
                    className="object-contain w-full h-auto group-hover:opacity-90 transition-opacity duration-300"
                    priority
                  />
                </div>
              </Link>
            ...
            {/* 
              ...
              - Alineada al inicio verticalmente con el logo
              - Ocupa 1fr en desktop (proporción flexible)
            */}
            ...
            {/* 
              Columna 3: Contacto y direcciones
              - Alineada al inicio verticalmente con el logo
              - Ocupa 1fr en desktop (proporción flexible)
            */}
          ...
          {/* 
            ...
            Layout flex simple para esta sección
          */}
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4 pb-6 lg:pb-8">
            {/* Copyright */}
